...
def make_naive(df, cat, num, features, naive_attributes=None, countries=None):
    ...
    if naive_attributes is None:
        naive_attributes = ['enterpriseToEbitda', 'sector', 'industry',
                            ...
                            'averageVolume10days',
                            'country']  # ['sector','fullTimeEmployees','averageVolume10days','city','state','country','maxAge','industry','numberOfAnalystOpinions','financialCurrency','exchange','exchangeTimezoneName','market','currency','isEsgPopulated']#['sector','city','country','industry','fullTimeEmployees','exchange','market','currency'] #,'fullTimeEmployees' #['sector','fullTimeEmployees','averageVolume10days','city','state','country','maxAge','industry','numberOfAnalystOpinions','financialCurrency','exchange','exchangeTimezoneName','market','currency','isEsgPopulated']
    else:
...
def getData(dataset, **kwargs):
    ...
    # Stock5YLarge on 5 year monthly selected only the right columns
        ...
        descriptive_df = pickle.load(
            open("C:/Users/bengelen003/OneDrive - pwc/Code/HP/descriptive_attributes_5yData_large.pkl", "rb")).copy()
        target_att_5y_large = pickle.load(
            open("C:/Users/bengelen003/OneDrive - pwc/Code/HP/target_attributes_5yData_large.pkl", "rb")).copy()
